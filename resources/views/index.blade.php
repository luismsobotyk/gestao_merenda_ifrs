                    ...
                    <section class="menu">
                        @foreach($dia['horarios'] as $hIndex => $horario)
                            <article class="period p-{{ $hIndex % 4 }}">
                                <div class="d-flex align-items-center justify-content-center gap-3 w-100 mb-4" style="flex-direction: row !important;">
                                    <div class="d-flex align-items-center gap-3" style="margin: 0;">
        <span class="period-ico m-0" style="flex-shrink: 0;">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16"><path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z"/><path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z"/></svg>
                                        ...
                                        <div class="period-meta text-start m-0">
                                            <h2 style="margin: 0;">{{ $horario['nome'] }}</h2>
                                        </div>
                                    </div>
                                    <span class="period-time m-0" style="white-space: nowrap; margin: 0 !important;">{{ substr($horario['hora_inicio'], 0, 5) }}–{{ substr($horario['hora_fim'], 0, 5) }}</span>
                                </div>
